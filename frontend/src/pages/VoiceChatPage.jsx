...
export default function VoiceChatPage() {
  ...
  const {
    speak: speakAvatar, // Rename 'speak' -> 'speakAvatar'
    isSpeaking: isAvatarSpeaking, // Rename 'isSpeaking' -> 'isAvatarSpeaking'
    viseme,
    stop: stopAvatar,
  } = useAzureAvatar();
